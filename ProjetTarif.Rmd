...
# paramètre : 
  .Proportion.Wanted = 0.01 # pour des question de rapiditée d'exection, j'ai déscendu la proportion a 0.01, il faut la remonter a 0.8 avent de rendre le code.
...
# Commentaire : Les dataset de traning et de tests d'apellent proper.$$$ pour éviter de les confondre. 
...
```{r "Base fréquence : typage des champs, regrouppement de modalitées et fitting des modèles",include=FALSE}
...
```{r "Fitting d'un modèle de fréquence sur la base fréquence",include=FALSE}
